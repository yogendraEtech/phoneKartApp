...
class SmartphoneTable extends Component {
  ...
  render(){
   // console.log(this.props.searched,'searched')
    //console.log(this.props.inventory_data,'kkkkkkkkkkkkkkkkkkkkkk')
    let filteredData = this.props.inventory_data.filter(  (v)=> {
      return v.isSmartphone == true
    });
    
    var searchedData=this.props.inventory_data.filter(  (v)=> {
      var searched=this.props.searched
      return v.title.includes(searched);
    });

     console.log(searchedData,'searcharray')
    return(
      ...
      {  this.props.searched? 
        ...
        <div>
           <Row className='items'>
         <Col xs="6" sm="4"> 
         <img style={{height:'90%',maxWidth:'100%',marginLeft:'30%'}} src={v.thumbnailUrl}/>
         </Col>
